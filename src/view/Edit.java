...
public class Edit extends JDialog {
	...
	private List<Object[]> selectedKorisnikList;

	public Edit(TableGenerator korisniciTable) {
	    this.korisniciTable = korisniciTable;
	    this.selectedKorisnikList = this.korisniciTable.getDataFromSelectedRow();
	    if (selectedKorisnikList != null && !selectedKorisnikList.isEmpty()) {
	        // Take the first element from the list as the selected data
	        Object[] rowData = selectedKorisnikList.get(0);
	        // Set the values of the input fields based on the selected data
	        initComponents();
	       // txtUsername.setText(rowData[1].toString());
	        // ...
